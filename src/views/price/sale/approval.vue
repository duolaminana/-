  ...
  <div class="app-container saleModifyPrice">
    ...
    <div>
      <el-table
        ...
        <el-table-column align="center" :label="$t('price.saleView.attrValueList')" prop="attrValueList" >
          <template slot-scope="scope">
            {{isZh ? scope.row.cnAttrValueList : scope.row.enAttrValueList}}
          </template>
        </el-table-column>

        <el-table-column align="center" :label="$t('price.saleView.originalPrice')" prop="name" />

        <el-table-column align="center" :label="$t('price.saleView.priceNumber')"/>

        <el-table-column align="center" :label="$t('price.saleView.adjustRatio')"/>

        <el-table-column align="center" :label="$t('price.saleView.afterPrice')"/>
