      ...
      <el-row :gutter="28">
        <el-col>
          <el-form-item :label="$t('system.business.currencyCode')" prop="currencyCode2">
            <el-select filterable remote :remote-method="selectCurrencyCodeListFun2" :loading="loading1" v-model="formMaterial.currencyCode2" clearable :placeholder="$t('system.business.searchCurrencyCode')" style="width: 200px">
        ...
        <el-col :span="13">
          <el-form-item :label="$t('system.business.priceGradient')" prop="priceGradient">
            <el-select v-model="formMaterial.priceGradient" clearable style="width: 200px">
        ...
        <el-col :span="13">
          <el-form-item :label="$t('system.business.toleranceNumber')" prop="toleranceNumber">
            <el-input v-model.number="formMaterial.toleranceNumber" :min="0" :precision="0" clearable :placeholder="$t('system.business.toleranceNumber')" style="width: 200px" />&nbsp;%
          </el-form-item>
        </el-col>
        <el-col :span="11">
          <el-form-item :label="$t('system.business.validityPeriod')" prop="validityPeriod">
            <el-input v-model.number="formMaterial.validityPeriod" :min="0" :precision="0" clearable :placeholder="$t('system.business.validityPeriod')" style="width: 200px" />&nbsp;{{$t('system.business.day')}}
          </el-form-item>
        </el-col>
        <el-col>
...
export default {
  ...
  created() {
    ...
    this.selectCurrencyCodeListFun2(); // 币种列表
  },
  methods: {
