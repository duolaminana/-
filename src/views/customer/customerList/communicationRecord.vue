  ...
  <div class="app-container goutong-test">
    <div class="connectRecord">
      <div class="cusInfo">
        <div class="cus-grade">
          <div class="grade-img">
            <img v-if="gradeObj.smallMark" :src="fullUrl(gradeObj.smallMark)" alt="">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='add'?'客户沟通记录新增': '客户沟通记录编辑'" center width="950px" @closed="clearData">
      <el-form ref="addCompany" :model="adsPosition" label-width="100px" label-position="left" size="small" inline :rules="adsPositionRules">
    ...
    <el-dialog :visible.sync="detailModal" title="客户沟通记录详情" center width="950px" @closed="clearData">
      <el-form ref="addCompany" :model="adsPosition1" label-width="100px" label-position="left" size="small" inline :rules="adsPositionRules">
        <el-form-item label="联系人" prop="contact">
