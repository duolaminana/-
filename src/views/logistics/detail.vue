<template>
  <div class="app-container logisticOrderDetail">
      ...
      <el-row :gutter="16">
        ...
        <el-col>
          <el-form-item :label="$t('logistics.logisticsOrder.orderNo')" prop="orderNoArr">
            <el-input v-model="detailForm.orderNo" readonly :placeholder="$t('logistics.logisticsOrder.orderNo')" style="width:500px;"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item :label="$t('logistics.logisticsOrder.customerBasicInfoBId')" prop="customerBasicInfoBId">
        ...
        <el-col :span="12">
          <el-form-item :label="$t('logistics.logisticsOrder.transportationMethod')" prop="transportationMethod">
            <el-select v-model="detailForm.transportationMethod" disabled>
              <el-option label="汽运" :value="1"></el-option>
              <el-option label="铁路" :value="2"></el-option>
              <el-option label="海运" :value="3"></el-option>
        ...
        <el-col :span="12">
          <el-form-item :label="$t('logistics.logisticsOrder.paymentCurrency')" prop="paymentCurrency">
            <el-select filterable remote :remote-method="getCurrencyCodeList" :loading="loading2" v-model="detailForm.paymentCurrency" disabled>
        ...
        <el-col :span="24">
          <el-table
            ...
            <el-table-column align="center" :label="$t('logistics.logisticsOrder.productName')" prop="productName" />
            ...
            <el-table-column align="center" :label="$t('logistics.logisticsOrder.clientProductRef')" prop="clientProductRef" show-overflow-tooltip />
    ...
    <div style="margin: 30px 0; text-align: center">
      <el-button type="danger" @click="closePage">{{$t('common.buttonText.back')}}</el-button>
    </div>
  </div>
</template>
