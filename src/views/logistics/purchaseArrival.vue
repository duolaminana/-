<template>
  <div class="app-container stock">
    <div class="edit-title">{{$t('logistics.arrival.purchaseArrivalTitle')}}</div>
...
import { updateOrderFlowInfo, selectOrderWorkflowNodeBIdApi } from '@/api/order'
...
export default {
  ...
  methods: {
    ...
    getLogisticsOrderDetailListFun() {
      ...
      // 根据采购订单bid获取物流订单详情列表数据
      selectLogisticsOrderDetailList({ orderBId: this.$route.query.id, logisticeType: 2 }).then(res => {
