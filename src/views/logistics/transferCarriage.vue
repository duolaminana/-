      ...
      <el-row class="row-item">
        ...
        <el-form ref="stockForm" :model="stockForm" label-width="190px" size="small" :rules="stockFormRules">
          ...
          <el-form-item :label="$t('logistics.carriage.eventRemark')" prop="eventRemark">
            <el-input v-model="stockForm.eventRemark" :maxlength="200" :autosize="{ minRows: 3, maxRows: 5}" type="textarea" size="small" clearable style="width: 60%"/>
          </el-form-item>
        </el-form>
      </el-row>
      <el-row class="row-item">
        ...
        <div v-for="(logistic,index1) in logisticsOrderDetailList" :key="index1">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('logistics.carriage.transportationMethod')">
              <el-select v-model="logistic.transportationMethod" clearable style="width: 270px">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('logistics.carriage.vesselBookingNo')">
              <el-input v-model="logistic.vesselBookingNo" :maxlength="15" size="small" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('logistics.carriage.shippingFlightNo')">
              <el-input v-model="logistic.shippingFlightNo" :maxlength="30" size="small" clearable/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import { typeNodeSaleOrder, updateOrderFlowInfo, selectOrderWorkflowNodeBIdApi } from '@/api/order'
...
export default {
  ...
  created() {
    this.getSaleOrderDetail(); // 转单订单详情
    this.getTypeNodeSaleOrder(); // 根据节点类型获取流程节点
    this.getLogisticsOrderDetailListFun(); // 根据转单订单bid获取物流订单详情列表数据
  },
  filters: {
    timeFmt(val) {
      if (val) {
  ...
  methods: {
    ...
    // 根据转单订单bid获取物流订单详情列表数据
    getLogisticsOrderDetailListFun() {
      // 根据转单订单bid和订单节点bid获取某个节点详情
