<template>
  <div class="app-container promotionProduct">
    ...
    <el-table
      ...
      <el-table-column header-align="center" label="所属类目" prop="cnCatalogBName" show-overflow-tooltip/>
      <el-table-column header-align="center" label="商品编码" prop="productCode" show-overflow-tooltip/>
      <el-table-column header-align="center" label="商品名称" prop="cnProductName" show-overflow-tooltip/>
    ...
    <el-dialog :visible.sync="dialogVisible1" title="添加商品" width="700px" center>
      ...
      <div style="margin: 10px 0">
        ...
        <el-table
          ...
          <el-table-column align="center" label="所属类目" prop="cnCatalogBName" />
          <el-table-column align="center" label="商品编码" prop="productCode" />
          <el-table-column align="center" label="商品名称" prop="cnProductName" />
        </el-table>
