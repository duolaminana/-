<template>
  <div class="app-container biddingPrice">
    <div class="search-box">
      <el-form label-width="90px" inline size="small">
        ...
        <el-form-item label="类目名称">
          <el-input v-model="postData.cnCatalogName" clearable placeholder="请输入类目名称" style="width: 200px" />
        </el-form-item>
        <el-form-item>
    ...
    <el-table
      ...
      <el-table-column label="类目名称" prop="cnCatalogName" show-overflow-tooltip/>
    ...
    <el-dialog :visible.sync="dialogVisible" title="新增竞价类目" center width="500px" @closed="clearData">
      <div>
        ...
        <el-tree
          ...
          show-checkbox
          node-key="id"
          :props="{value: 'bid', label: 'cnCatalogName', children: 'children'}"
...
export default {
  ...
  methods: {
    ...
    filterNode(value, data) {
      ...
      return data.cnCatalogName.indexOf(value) !== -1;
    },
