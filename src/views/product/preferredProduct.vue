<template>
  <div class="app-container preferredProduct">
    ...
    <el-table
            ...
            <div class="table-expand" v-for="(item, childIndex) in props.row.childs" :key="childIndex">
              ...
              <div class="table-flex">
                <div class="sku-attr">
                  ...
                  <div class="sku-content">{{item.cnAttrValueList}}</div>
                </div>
                <div class="sku-msg">
      ...
      <el-table-column label="所属类目" prop="cnCatalogBName" show-overflow-tooltip/>
      <el-table-column label="商品编码" prop="productCode" show-overflow-tooltip/>
      <el-table-column label="商品名称" prop="cnProductName" show-overflow-tooltip/>
