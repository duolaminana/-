<template>
  <div class="app-container stock">
    <div class="edit-title">{{$t('order.purchase.orderStock')}}</div>
...
export default {
  ...
  data() {
    return {
      ...
      stockFormRules: {
        attachmentUploadTime: [{ required: true, message: 'Stock Date', trigger: 'change' }],
        completeDegree: [{ required: true, message: 'Fill in Proportion', trigger: 'blur' }]
      },
      allNodeList: [],
      recordList: [],
      fileList: [],
