  ...
  <div class="app-container check">
    ...
    <el-form ref="detailForm" :model="detailForm" label-width="140px" size="small" class="edit-form">
      ...
      <el-form-item style="text-align: center;margin-top: 20px">
        <el-button type="primary" v-if="!isComplete" size="small" :loading="confirmLoading" @click="saveClick('checkForm')">{{$t('common.buttonText.submit')}}</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      checkFormRules: {
        adjustAmount: [{ required: true, message: 'Fill in the adjust amount', trigger: 'blur' }],
        orderRemarks: [{ required: true, message: 'Fill in the remark', trigger: 'blur' }]
      },
      orderSkuList: [],
      allNodeList: [],
      recordList: [],
