...
<!--            </el-table-column>-->
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType=== 'add' ? '新增收款记录' : '编辑收款记录'" width="450px" center close-on-click-modal @close="clearData">
      <el-form ref="addForm" :model="addForm" label-width="90px" label-position="left" size="small" :rules="addFormRules">
    ...
    <el-dialog :visible.sync="dialogVisible1" title="收款记录详情" width="450px" center close-on-click-modal>
      <el-form :model="addFormDetail" label-width="90px" label-position="left" size="small">
        <el-form-item label="收款日期" prop="collectionTime">
        ...
        <el-form-item label="附件" prop="component">
          <el-table
            ...
            <el-table-column align="center" label="操作">
              <template slot-scope="scope">
                <el-button type="primary" size="mini" class="export" @click="downFile(scope.row)">查看</el-button>
              </template>
            </el-table-column>
