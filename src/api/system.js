 ...
 * 导出角色排版列表-前台导出
 */
export function exportFrontendRoleByEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/role/exportFrontendRoleByEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 导出角色排版列表-后台导出
 */
export function exportBackendRoleByEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/role/exportBackendRoleByEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 查询角色拥有的菜单 -- 后台
export function backendGetMenuByRoleId(option) {
  return request.get(`/backend-admin/role/getMenuByRoleId`, { params: option })
}
...
//  显示菜单所拥有的权限 - 前台
export function getFrontMenuAllByRoleId(option) {
  return request.get(`/backend-admin/role/getFrontMenuAllByRoleId`, { params: option })
}
...
// 菜单列表
export function getMenuTwoList(option) {
  return request.get(`/backend-admin/sysAuthorityMenu/selectMenuTwoList`, { params: option })
}

// 导出菜单列表excel列表
export function exportByMenuList(option) {
  return axios({
    method: 'get',
    data: option,
    url: `${uploadBaseApi}/backend-admin/sysAuthorityMenu/exportByMenuList`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 前台菜单二级列表
export function getClientMenuTwoList(option) {
  return request.get(`/backend-admin/frontendMenu/selectMemuTwoList`, { params: option })
}

// 前台菜单列表导出
export function exportFrontendMenuList(option) {
  return axios({
    method: 'get',
    data: option,
    url: `${uploadBaseApi}/backend-admin/frontendMenu/exportFrontendMenuList`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 修改企业启用禁用
export function changeCompanyStatus(option) {
  return request.get(`/backend-admin/parameter/updateCompanyStatus`, { params: option })
}
...
// 查看所有主体企业账号列表 无分页
export function selectCompanyListAll(option) {
  return request.get(`/backend-admin/parameter/selectCompanyListAll`, { params: option })
}
...
// 部门排序
export function updateDepSequenceNew(option) {
  return request.get(`/backend-admin/department/updateDepSequenceNew`, { params: option })
}
...
// 无分页-查看广告位置列表
export function getAdvertPositionListApi(option) {
  return request.get(`/backend-admin/advertPosition/getAdvertPositionList`, { params: option })
}
/**
 *
 * 导出广告位置列表-导出
 */
export function exportBySysAdPositionExcel(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/advertPosition/exportBySysAdPosition`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 导出广告内容列表-导出
 */
export function exportBySysAdDetailExcel(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/advert/exportBySysAdDetail`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 导出广告排版列表-导出
 */
export function exportBySysAdSchedulingExcel(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/sysAdScheduling/exportBySysAdScheduling`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 导出用户排版列表-后台导出
 */
export function exportBackendUserByEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-user/sysUser/exportBackendUserByEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 导出用户排版列表-前台导出
 */
export function exportFrontendUserByEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-user/user/exportFrontendUserByEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 删除客户供应商
export function deleteCustomerOrAccountById(option) {
  return request.get(`/backend-customer/customerOrAccount/deleteCustomerOrAccountById`, { params: option })
}

// 新增客户供应商
export function saveCustomerOrAccountBody(option) {
  return request.post(`/backend-customer/customerOrAccount/saveCustomerOrAccountBody`, option)
}

// 客户供应商列表
export function selectCustomerOrAccountList(option) {
  return request.get(`/backend-customer/customerOrAccount/selectCustomerOrAccountList`, { params: option })
}

// 新增用户
export function addUserFrontend(option) {
  return request.post(`/backend-user/user/addUserFrontend`, option)
}

// 根据用户名查询
export function getUserFrontendByUserAccount(option) {
  return request.get(`/backend-user/user/getUserFrontendByUserAccount`, { params: option })
}
...
// 重置密码
export function UserresetPwd(option) {
  return request.get(`/backend-user/user/resetPwd`, { params: option })
}
...
// 字典查询导出
export function exportBySysDictionary(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/sysDictionary/exportBySysDictionary`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 更新启禁用操作
export function updateDictStatusApi(option) {
  return request.get(`/backend-admin/sysDictionary/updateDictStatus`, { params: option })
}
...
// 字典查询 接口2-new -- 对外接口
export function selectgetDictionaryBykeyApi(option) {
  return request.get(`/backend-admin/sysDictionary/getDictionaryBykeyNew`, { params: option })
}
...
// 主流程启用禁用
export function changeFlowStatus(option) {
  return request.get(`/backend-admin/approvalFlow/updateApprovalStatus`, { params: option })
}
...
// 主流程导出excel接口
export function exportByApprovalFlowList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/approvalFlow/exportByApprovalFlowList`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 导出部门表(easypoi版)
 */
export function exportDepartmentApi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-admin/department/exportDepartment`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 通过ids进行备忘提醒对象从表批量删除
export function deleteSysMemoRemindUserByIds(option) {
  return request.post(`/backend-admin/sysMemoRemindUser/deleteSysMemoRemindUserByIds`, option)
}
...
// 分页查询-我的通知
export function noticeList(option) {
  return request.post(`/backend-notification/sysNoticeRecording/getMyNoticeList`, option)
}

// 分页查询-阅读我的通知
export function readMyNotice(option) {
  return request.get(`/backend-notification/sysNoticeRecording/haveRead`, { params: option })
}

// 通知任务列表导出excel
export function exportBySysNoticeTimingTask(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-notification/sysNoticeTimingTask/exportBySysNoticeTimingTask`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 模版列表导出
export function exportByNoticeTemplate(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-notification/sysNoticeTemplate/exportByNoticeTemplate`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
export function pagephNoticeRecording(option) {
  return request.post(`/backend-notification/sysNoticeRecording/pagephNoticeRecording`, option)
}

// 系统通知记录导出excel
export function exportBySysNoticeRecording(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-notification/sysNoticeRecording/exportBySysNoticeRecording`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 重新发送
export function sysNoticeRecordingResend(option) {
  return request.post(`/backend-notification/sysNoticeRecording/resend`, option)
}
...
// 审核管理待办列表
export function getApprovalList(option) {
  return request.get(`/backend-admin/agendaItem/pageph`, { params: option });
}

// 审核管理导出
export function exportByAgendaItem(option) {
  return axios({
    method: 'get',
    data: option,
    url: `${uploadBaseApi}/backend-admin/agendaItem/exportByAgendaItem`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
