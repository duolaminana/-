...
// 启用
export function rightUpdateStatus(option) {
  return request.get(`/backend-member/memberRight/updateStatus`, { params: option })
}

/**
 * 会员权益列表-导出
 */
export function rightExportEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-member/memberRight/exportEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 会员活动列表-导出
 */
export function activityExportEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-member/memberActivity/exportEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 会员活动参与者列表-导出
 */
export function exportActivityEnrollEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-member/memberActivity/exportActivityEnrollEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
export function updateMemberLevelStatus(option) {
  return request.get(`/backend-member/memberLevel/updateStatus`, { params: option })
}
 ...
 * 会员等级列表-导出
 */
export function levelExportEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-member/memberLevel/exportEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 获取列表
export function listMemberCategory(option) {
  return request.get(`/backend-member/memberCategory/listMemberCategory`, { params: option })
}
...
// 启用
export function updateStatusCatagory(option) {
  return request.get(`/backend-member/memberCategory/updateStatus`, { params: option })
}

/**
 * 会员分类列表-导出
 */
export function categoryExportEasypoi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-member/memberCategory/exportEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
