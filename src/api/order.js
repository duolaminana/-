...
// 收款文件下载
export function downloadProofData(option) {
  // return request.get('/backend-order/salesCollectionProof/downloadProofData', { params: option });
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-order/salesCollectionProof/downloadProofData`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// export const downloadProofData = `${uploadBaseApi}/backend-order/salesCollectionProof/downloadProofData`;
 ...
 * 导出销售订单(easypoi版)
 */
export function exportSalesOrderExcelApi(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-order/salesOrder/exportBySalesOrder`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 导出销售订单
export function exportBySalesOrderOne(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-order/salesOrder/exportBySalesOrderOne`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 代客户确认销售订单
export function confirmSaleOrder(option) {
  return request.get(`/backend-order/salesOrder/clientConfirm`, { params: option });
}

// 作废销售订单
export function voidSaleOrder(option) {
  return request.get(`/backend-order/salesOrder/cancellation`, { params: option });
}
...
export function selectWorkflowProcessListApi(option) {
  return request.post(`/backend-order/workflowProcess/selectWorkflowProcessList`, option)
}

// 更新-调整当前触发节点
export function updateCurrentNodeApi(option) {
  return request.post(`/backend-order/workflowProcess/updateCurrentNode`, option)
}
...
// 新增采购订单备货记录
export function updatePurchaseOrderFlowInfo(option) {
  return request.post(`/backend-order/workflowProcess/updateByIdForPurchaseOrder`, option);
}
...
export function exportPisExcelList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-order/purchaseInquirySingle/exportPisExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
