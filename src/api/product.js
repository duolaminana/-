...
// 获取商品不在优选商品列表中的数据
export function getPreferredProductList(option) {
  return request.get(`/backend-product/productInfo/getProductPreferredPage`, { params: option });
}
...
// 根据商品id获取新商品宣传图片列表
export function getNewProductImgList(option) {
  return request.get(`/backend-product/productImge/selectProductImgForNewProduct`, { params: option });
}
...
// 高级搜索
export function pageByAdvanceQueryForm(option) {
  return request.post(`/backend-product/productInfo/pageByAdvanceQueryForm`, option);
}
...
// 根据类型获取商品列表  标准
export function productListGet(option) {
  return request.post(`/backend-product/productSkuShelf/selectSkuPageInfo`, option);
}

// 根据类型获取商品列表  标准有价格
export function productListGetPrice(option) {
  return request.post(`/backend-product/productSkuShelf/selectSkuForSaleOrder`, option);
}
...
// 产品档案启用
export function updateProductTypeByIds(option) {
  return request.get(`/backend-product/productInfo/updateProductTypeByIds`, { params: option });
}
 ...
 * 高级搜索-导出
 */
export function exportExcelByAdvanceQueryForm(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productInfo/exportExcelByAdvanceQueryForm`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
export function exportExcelProductList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productInfo/exportProductInfoExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
...
// 成本管理产品列表
export function getCostProductList(option) {
  return request.post(`/backend-product/productStandard/pageInfoProductForCostPrice`, option);
}
 ...
 */
export function exportExcelCategoryModalList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productCatalogTemplate/exportExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * @returns {AxiosPromise}
 */
export function exportExcelStandardProductList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productStandard/exportProductStandardExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * @returns {AxiosPromise}
 */
export function exportExcelProductNewList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productNew/exportProductNewToExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * @returns {AxiosPromise}
 */
export function exportExcelProductMaterialList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productRawMaterial/exportRawMaterialExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * @returns {AxiosPromise}
 */
export function exportExcelProductCatalogList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-product/productCatalog/exportProductCatalogExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
