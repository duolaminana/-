...
// 销售订单详情
export function transferOrderDetail(option) {
  return request.get(`/backend-order/transitradeOrder/detail`, { params: option });
}
...
// 销售订单列表
export function getTransferOrderList(option) {
  return request.post(`/backend-order/transitradeOrder/pageph`, option);
}
...
// 查询转单订单商品
export function getTransferOrderSkuByBId(option) {
  return request.get(`/backend-order/transitradeOrder/getProductBySalesOrderBid`, { params: option });
}
