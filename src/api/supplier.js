...
// 查询是否存在联系人
export function findContact(option) {
  return request.post('/backend-supplier/supplierContact/findContact', option);
}
...
// 供应商启用禁用
export function supplierStatusUpdate(option) {
  return request.get('/backend-supplier/supplierInfo/updateSupplierStatus', { params: option });
}
// 供应商详情
...
// 供应商联系人默认
export function updateContactById(option) {
  return request.post('/backend-supplier/supplierContact/updateContactById', option);
}
// 等级列表无分页
...
// 供应商修改查询列表
export function supplierHistoryList(option) {
  return request.get('/backend-supplier/supplierModifyRecord/pagephSupplierModifyRecord', { params: option });
}
// 供应商修改历史详情
export function supplierHistoryDetail(option) {
  return request.get('/backend-supplier/supplierModifyRecord/detailSupplierModifyRecord', { params: option });
}
...
export function exportExcelSupplierList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-supplier/supplierInfo/exportSupplierInfoExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * 供应商服务人员列表-导出
 */
export function exportExcelSupplierServingList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-supplier/supplierServing/exportSupplierServingExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 */
export function exportExcelSupplierProductSkuList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-supplier/supplierProductSku/exportSupplierProductSkuExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
 ...
 * @returns {AxiosPromise}
 */
export function exportExcelCommunicationList(option) {
  return axios({
    method: 'post',
    data: option,
    url: `${uploadBaseApi}/backend-supplier/supplierCommunication/exportCommunicationExcel`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
