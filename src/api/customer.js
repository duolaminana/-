...
// 流程节点
export function selectWorkflowNodeListNodeType(option) {
  return request.get('/backend-admin/workflowNode/selectWorkflowNodeListNodeType', { params: option });
}
// 默认账户
export function setDefaultValue(option) {
  return request.get('/backend-customer/customerContact/setDefaultValue', { params: option });
}

// 查询是否存在联系人
export function findContact(option) {
  return request.post('/backend-customer/customerContact/findContact', option);
}
...
// 禁用
export function customerupdateStatus(option) {
  return request.get('/backend-customer/customerInfo/updateStatus', { params: option });
}
...
// 客户修改查询列表
export function customerHistoryList(option) {
  return request.post('/backend-customer/customerModifyRecord/pagephCustomerModifyRecord', option);
}
// 客户修改历史详情
export function historyDetail(option) {
  return request.get('/backend-customer/customerModifyRecord/detailCustomerModifyRecord', { params: option });
}
...
// 客户列表
export function getCustomerSaleableCategory(option) {
  return request.get('/backend-customer/customerProductSpec/getProductSpecAllByBIdAndType', { params: option });
}
...
export function exportCustomer() {
  return axios({
    method: 'post',
    url: `${uploadBaseApi}/backend-customer/customerInfo/exportExcelByEasypoi`,
    headers: {
      token: getToken()
    },
    responseType: 'blob'
