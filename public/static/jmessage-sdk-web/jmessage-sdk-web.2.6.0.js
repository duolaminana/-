...
function(t, e) {
	...
	return function(t) {
		...
		l.prototype.init = function(t) {
			...
			this.__checkLogin();
			var e, n = this;
			t.gid ? e = String(t.gid) : (t.appkey || (t.appkey = n.current_appkey), e = t.appkey + t.username), n.conversations[e] = void 0 === n.conversations[e] ? {} : n.conversations[e], t.gid ? n._updateGroupUnreadCount({
				gid: t.gid
			...
			Array.prototype.push.apply([], t.messages.map(function(t) {
				...
				}, e.conversations[o] || (e.conversations[o] = {}, e.conversations[o].extras = {}, e.conversations[o].unread_msg_count = 0, e.conversations[o].msg_time = []), e.current_conversation === o || r ? (e.conversations[o].recent_time = t.ctime_ms, e.conversations[o].unread_msg_count = 0, e.conversations[o].msg_time = []) : (e.conversations[o].unread_msg_count = e.conversations[o].unread_msg_count + 1, e.conversations[o].msg_time.push(t.ctime_ms)), new a(e.channel).setEvent(s.EVENTS.MSG_RECV_V2).setData({
					msg_id: t.msg_id,
					msg_type: t.msg_type,
					from_uid: t.from_uid,
					from_gid: t.from_gid
			...
			e.channel.sync_key = t.sync_key, t.messages && (t.messages.forEach(function(t) {
				...
				if (e.current_conversation === n) e.conversations[n] = void 0 === e.conversations[n] ? {} : e.conversations[n], e.conversations[n].unread_msg_count = o, e.conversations[n].recent_time = r, e.conversations[n].msg_time = [];
			...
			new a(e.channel).setEvent(s.EVENTS.SYNC_EVENT_ACK).setData(n).send(), setTimeout(function() {
				if (e._onSyncEventFn && t.events && t.events.length > 0) {
					...
					t.events.forEach(function(o) {
						if (200 === o.event_type) 3 === o.description.type ? e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.appkey, o.description.username) : e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.gid);
						else {
			...
			if (s.type = t, 3 === t ? (r = n + o, s.username = o, s.appkey = n) : (r = String(n), s.gid = n), i.conversations[r] = void 0 === i.conversations[r] ? {
				msg_time: [],
				unread_msg_count: 0
			} : i.conversations[r], i.conversations[r].recent_time = e, i.current_conversation === r) i.conversations[r].unread_msg_count = 0, i.conversations[r].msg_time = [];
			else {
		...
		(function(n) {
			...
			function(n, s) {
				...
				function p(t, e) {
					var n, o, r = this;
					return t instanceof p ? t : r instanceof p ? (r._chain = 0, r._success = r._parallel = r._series = null, r._finally = r._error = r._result = r._nextThen = null, arguments.length ? (n = d(r, e), void(void 0 === (t = null == (o = t) ? o : "function" == typeof o.toThunk ? o.toThunk() : "function" == typeof o.then ?
					function(t) {
						o.then(function(e) {
							t(null, e)
						}, t)
		...
		s.prototype.init = function(t) {
			this.opts = t, this.dataCache = {}, this.memStore = {}, this.sync_key = 0, this.sync_type = 0, this.client = r(this.opts.address, {
		...
		e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = c, e.Decoder = p, c.prototype.encode = function(t, n) {
			(o("encoding packet %j", t), e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) ?
			function(t, e) {
			...
			}(t), e.BINARY_EVENT == n.type || e.BINARY_ACK == n.type ? (this.reconstructor = new h(n), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", n)) : this.emit("decoded", n);
			else {
						...
						if ("bug-string-char-index" == t) r = "a" != "a" [0];
							...
							if ("json-stringify" == t) {
								...
								if (u) {
									...
									try {
										u = "0" === c(0) && "0" === c(new n) && '""' == c(new o) && c(g) === _ && c(_) === _ && c() === _ && "1" === c(s) && "[1]" == c([s]) && "[null]" == c([_]) && "null" == c(null) && "[null,null,null]" == c([_, g, null]) && c({
											a: [s, !0, !1, null, "\0\b\n\f\r\t"]
						...
						if ((f = y.hasOwnProperty) || (f = function(t) {
							...
							var C = {
								...
								D = function(t, e, n, o, r, i, s) {
									...
									if ("object" == typeof a && a) if ("[object Date]" != (c = g.call(a)) || f.call(a, "toJSON"))"function" == typeof a.toJSON && (c != k && c != S && c != T || f.call(a, "toJSON")) && (a = a.toJSON(t));
									else if (a > -1 / 0 && a < 1 / 0) {
										if (R) {
							...
							e.stringify = function(t, e, n) {
								var o, r, i, a;
								if (s[typeof e] && e) if ((a = g.call(e)) == E) r = e;
								else if (a == T) {
									i = {};
						...
						if (!v("json-parse")) {
							var I, x, L = o.fromCharCode,
								...
								U = function() {
									...
									case 34:
										for (t = "@", I++; I < s;) if ((r = i.charCodeAt(I)) < 32) P();
								...
								G = function(t) {
									...
									if ("$" == t && P(), "string" == typeof t) {
										...
										if ("[" == t) {
											for (e = [];
											"]" != (t = U()); n || (n = !0)) n && ("," == t ? "]" == (t = U()) && P() : P()), "," == t && P(), e.push(G(t));
											return e
										}
										if ("{" == t) {
											for (e = {};
											"}" != (t = U()); n || (n = !0)) n && ("," == t ? "}" == (t = U()) && P() : P()), "," != t && "string" == typeof t && "@" == (b ? t.charAt(0) : t[0]) && ":" == U() || P(), e[t.slice(1)] = G(U());
											return e
										}
										P()
									}
								...
								V = function(t, e, n) {
									var o, r = t[e];
									if ("object" == typeof r && r) if (g.call(r) == T) for (o = r.length; o--;) B(r, o, n);
									else d(r, function(t) {
										B(r, t, n)
									});
									return n.call(t, e, r)
		...
		(function(t) {
			...
			e.deconstructPacket = function(t) {
				...
				function e(a, c, u) {
					...
					} else if (o(a)) for (var h = 0; h < a.length; h++) e(a[h], h, a);
					else if (a && "object" == typeof a && !r(a)) for (var l in a) e(a[l], l, a)
				}(s), i || n(s)
			}
		}).call(e, window)
	}, function(t, e) {
		...
		t.exports = f, f.prototype.emitAll = function() {
			...
			function i() {~p(o.connecting, n) || o.connecting.push(n)
			}
			return n
					...
					n || (i('probe transport "%s" opened', t), e.send([{
						...
						if (!n) if ("pong" === r.type && "probe" === r.data) {
							...
							h.priorWebsocketSuccess = "websocket" === e.name, i('pausing current transport "%s"', o.transport.name), o.transport.pause(function() {
								n || "closed" !== o.readyState && (i("changing transport and sending upgrade packet"), l(), o.setTransport(e), e.send([{
									type: "upgrade"
		...
		(function(e) {
			...
			h || "undefined" != typeof window || (h = o), t.exports = l, a(l, r), l.prototype.name = "websocket", l.prototype.supportsBinary = !0, l.prototype.doOpen = function() {
				...
				var n = this;
				this.writable = !1;
				for (var o = t.length, r = 0, s = o; r < s; r++)!
				function(t) {
		...
		n.prototype.setNeedReceipt = function(t) {
			...
			if (n.no_offline = this.no_offline, n.no_notification = this.no_notification, n.custom_notification = this.custom_notification, n.target_name = e.target_name, n.need_receipt = this.need_receipt, "single" == e.target_type) n.target_id = e.target_id;
